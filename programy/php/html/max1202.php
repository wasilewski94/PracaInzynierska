...
<html>
<head>
<h2>Pomiar napiecia analogowego</h2>

<?php
    //plik konfiguracyjny
    $fconfig = fopen("konfiguracja_max1202.txt", "r"); 
    if($fconfig != false)
    {
...
function start()
{
    ...
    {
        $pid = shell_exec("nohup /home/pi/inzynierka/max1202_driver/complete_test.e > /dev/null & echo $!");
